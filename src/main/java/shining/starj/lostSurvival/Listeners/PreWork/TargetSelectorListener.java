...
import shining.starj.lostSurvival.Exceptions.InvalidCommandArgsException;
import shining.starj.lostSurvival.Exceptions.NotFoundPlayerException;
import shining.starj.lostSurvival.Listeners.AbstractEventListener;
import shining.starj.lostSurvival.Predicates.CommandPredicate;
import shining.starj.lostSurvival.Predicates.Conditions.*;
...
@Builder
public class TargetSelectorListener extends AbstractEventListener {
    /*
     *  플레이어 targetSelector
     */
